...
### Heatmap!
dsc_prs_layers <- ggplot(data = dsc_layers, aes(x = criteria, y = Layer)) +
  ...
  theme_dark()+
  ggtitle("Pressures Data Selection Criteria Scores")+
...
ggsave("figs/dsc_heatmap_gradient_prs.jpg", width=10, height=8, dpi=300)
