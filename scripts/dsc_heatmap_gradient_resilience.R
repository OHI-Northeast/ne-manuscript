...
### Heatmap!
dsc_res_layers <- ggplot(data = dsc_layers, aes(x = criteria, y = Layer)) +
...
ggsave("figs/dsc_heatmap_gradient_res.jpg", width=10, height=8, dpi=300)
